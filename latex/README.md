# Versão LaTeX do template de TCC em Geologia da UFSC

Modelo limpo e modular para o Trabalho de Conclusão de Curso de Graduação em Geologia da Universidade Federal de Santa Catarina. Esta pasta é autocontida: importe somente `latex/` no Overleaf ou compile `main.tex` dentro dela.
